...
const AllSchoolsPage: React.FC = () => (
  <>
    <Helmet><title>All Schools | Campus School Pantnagar Alumni Portal</title></Helmet>
    <div className="py-16 px-4 text-white text-center" style={{ background: 'linear-gradient(135deg, #0B6B4B 0%, #094d36 100%)' }}>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <h1 className="text-4xl font-black mt-2 mb-3">All Schools</h1>
        <p className="text-white">Explore all campuses that shaped generations of excellence</p>
      </motion.div>
    </div>
    <SchoolsSection />
    <CTABanner />
